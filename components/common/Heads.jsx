...
const Heads =(props)=>{
  ...
  let title = pathname && pathname === "/" ? "Encamp Adventures Pvt. Ltd.": (paymentdetails && paymentdetails !=="") ? 'Booking Details' : pathname.replace(/\//g, "");
	return(
      <Head>
    <meta charSet="UTF-8"/>
    <meta httpEquiv="X-UA-Compatible" content="IE=edge"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <title>Ziro Festival of Music:{title}</title>
    ...
    <meta property="og:image" content="/images/swiper-image-1.jpg" />
